...
#include <memory>
#include "../../DEVICE/STATION/station.h"
...
QT_MOC_LITERAL(1, 8, 15), // "onm_restart_bry"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9), // "emu_array"
QT_MOC_LITERAL(4, 35, 14), // "onm_update_bry"
QT_MOC_LITERAL(5, 50, 25), // "QMap<QString,QJsonObject>"
QT_MOC_LITERAL(6, 76, 13) // "mi_power_hash"

    },
    "station\0onm_restart_bry\0\0emu_array\0"
    "onm_update_bry\0QMap<QString,QJsonObject>\0"
    "mi_power_hash"
};
...
void station::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onm_restart_bry((*reinterpret_cast< QJsonArray(*)>(_a[1]))); break;
        case 1: _t->onm_update_bry((*reinterpret_cast< QMap<QString,QJsonObject>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
